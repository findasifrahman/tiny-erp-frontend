...
@Component({
  selector: 'app-list-office-purchase-item-list',
  templateUrl: './list-office-purchase-item-list.component.html',
  styleUrl: './list-office-purchase-item-list.component.scss'
})
export class ListOfficePurchaseItemListComponent implements OnInit {
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  displayedColumns: string[] = ['officepurchaseitemlistid','itemname','price','buttons'];
  displayedColumnsName: string[] = ['officepurchaseitemlistid','itemname','price','buttons'];
  AllElement: MatTableDataSource<any>;
  loading = false;
  spinner_value = 50;
  maincompanyid = localStorage.getItem('maincompanyid')
  constructor(private snackBar: MatSnackBar, private service: OfficePurchaseItemListService, public dialog: MatDialog,
  ...
  onUpdate(id: any) {
    this._router.navigate(['/editOfficePurchaseItemList', id]);
  }
}
