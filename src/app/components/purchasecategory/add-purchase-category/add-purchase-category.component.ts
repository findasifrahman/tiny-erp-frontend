...
@Component({
  selector: 'app-add-purchase-category',
  templateUrl: './add-purchase-category.component.html',
  styleUrl: './add-purchase-category.component.scss'
})
export class AddPurchaseCategoryComponent implements OnInit {
  spinner_value = 50;
  loading = false;
  form!: FormGroup;
  constructor(private service: PurchaseCategoryService,private snackBar: MatSnackBar,
