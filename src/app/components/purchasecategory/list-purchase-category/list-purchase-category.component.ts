...
@Component({
  selector: 'app-list-purchase-category',
  templateUrl: './list-purchase-category.component.html',
  styleUrl: './list-purchase-category.component.scss'
})
export class ListPurchaseCategoryComponent {
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  displayedColumns: string[] = ['itemname','description','buttons'];
  displayedColumnsName: string[] = ['itemname','description','buttons'];
  ...
  onUpdate(id: any) {
    this._router.navigate(['/editPurchaseCategory', id]);
  }
}
