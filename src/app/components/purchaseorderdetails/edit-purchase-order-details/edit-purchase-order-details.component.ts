...
@Component({
  ...
  styleUrl: './edit-purchase-order-details.component.scss'
})
export class EditPurchaseOrderDetailsComponent {
  id: any;
  purchaseid_arr : any[] = [];
  ...
  constructor(private service: PurchaseOrderDetailService,private snackBar: MatSnackBar,private route:ActivatedRoute,
