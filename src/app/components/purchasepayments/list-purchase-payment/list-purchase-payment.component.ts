...
@Component({
  selector: 'app-list-purchase-payment',
  templateUrl: './list-purchase-payment.component.html',
  styleUrl: './list-purchase-payment.component.scss'
})
export class ListPurchasePaymentComponent implements OnInit {
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  displayedColumns: string[] = ['purchasepaymentid','suppliercompany','paymentdate','amount','recievedby','buttons'];
  displayedColumnsName: string[] = ['purchasepaymentid','suppliercompany','paymentdate','amount','recievedby','buttons'];
  AllElement: MatTableDataSource<any>;
  loading = false;
  spinner_value = 50;
  maincompanyid = localStorage.getItem('maincompanyid')
  constructor(private snackBar: MatSnackBar, private service: PurchasePaymentService, public dialog: MatDialog,
  ...
  onUpdate(id: any) {
    this._router.navigate(['/editPurchasePayment', id]);
  }
