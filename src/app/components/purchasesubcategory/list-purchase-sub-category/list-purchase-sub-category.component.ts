...
@Component({
  selector: 'app-list-purchase-sub-category',
  templateUrl: './list-purchase-sub-category.component.html',
  styleUrl: './list-purchase-sub-category.component.scss'
})
export class ListPurchaseSubCategoryComponent implements OnInit{
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  displayedColumns: string[] = ['purchasesubcategoryid','categoryname','subcategoryname','price','buttons'];
  displayedColumnsName: string[] = ['purchasesubcategoryid','categoryname','subcategoryname','price','buttons'];
  AllElement: MatTableDataSource<any>;
  loading = false;
  spinner_value = 50;
  maincompanyid = localStorage.getItem('maincompanyid')
  constructor(private snackBar: MatSnackBar, private service: PurchaseSubCategoryService, public dialog: MatDialog,
  ...
  onUpdate(id: any) {
    this._router.navigate(['/editPurchaseSubCategory', id]);
  }
}
