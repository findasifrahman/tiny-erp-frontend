...
@Component({
  selector: 'app-list-salary-payroll',
  templateUrl: './list-salary-payroll.component.html',
  styleUrl: './list-salary-payroll.component.scss'
})
export class ListSalaryPayrollComponent implements OnInit{
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  displayedColumns: string[] = ['payrollid','employeename','date','salary','deduction','bonus','leavetaken','finalsalarypaid','buttons'];
  displayedColumnsName: string[] = ['payrollid','employeename','date','salary','deduction','bonus','leavetaken','finalsalarypaid','buttons'];
  AllElement: MatTableDataSource<any>;
  loading = false;
  spinner_value = 50;
  constructor(private snackBar: MatSnackBar, private service: SalaryPayrollService, public dialog: MatDialog,
  ...
  onUpdate(id: any) {
    this._router.navigate(['/editSalaryPayroll', id]);
  }
