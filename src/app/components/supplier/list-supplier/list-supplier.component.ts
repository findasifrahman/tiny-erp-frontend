...
export class ListSupplierComponent implements OnInit {
  ...
  displayedColumns: string[] = ['supplierid','suppliercompany','suppliercontactname','suppliercontactnumber','supplieraddress','buttons'];
  displayedColumnsName: string[] = ['supplierid','suppliercompany','suppliercontactname','suppliercontactnumber','supplieraddress','buttons'];
  AllElement: MatTableDataSource<any>;
  loading = false;
  spinner_value = 50;
  maincompanyid = localStorage.getItem('maincompanyid')
  constructor(private snackBar: MatSnackBar, private service: SupplierService, public dialog: MatDialog,
