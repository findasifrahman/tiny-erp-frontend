...
export class EmployeeService {
    ...
    Add(formval : any): Observable<any>{
        ...
        return this.http.post(routeurls.BASE_API_URL + routeurls.EMPLOYEE_URL,formval,options)
      }
      ...
      delete(id: any, mid: any): Observable<any> {
        ...
        let headers = new HttpHeaders({
          'Content-Type': 'application/json'});
        return this.http.delete<any>(routeurls.BASE_API_URL + routeurls.EMPLOYEE_URL ,{ params: new HttpParams().set('id', parseInt(id)).set('maincompanyid', mid) });
      }
}