...
export class PaymentSalesService {
    ...
    Add(formval : any): Observable<any>{
        ...
        return this.http.post(routeurls.BASE_API_URL + routeurls.PAYMENT_SALES_URL,formval,options)
      }
      ...
      delete(id: any): Observable<any> {
        ...
        let headers = new HttpHeaders({
          'Content-Type': 'application/json'});
        return this.http.delete<any>(routeurls.BASE_API_URL + routeurls.PAYMENT_SALES_URL + "/" + id )//, { params: new HttpParams().set('id', parseInt(id)) });
      }
}